...
- <strong>Distributed-Memory Linear Algebra</strong> <span style="float:right;"><em>Provided by: <a href="tpetra">Tpetra</a> </em></span><br />
...
- <strong>Iterative Linear Solvers</strong> <span style="float:right;"><em>Provided by: <a href="belos">Belos</a> </em></span><br />
...
- <strong>Direct Linear Solvers</strong> <span style="float:right;"><em>Provided by: <a href="amesos2">Amesos2</a> , <a href="shylu">ShyLU</a> , <a href="adelus">Adelus</a> </em></span><br />
...
- <strong>Large-Scale Eigenvalue Algorithms</strong> <span style="float:right;"><em>Provided by: <a href="anasazi">Anasazi</a> </em></span><br />
...
- <strong>One-Level Domain Decomposition</strong> <span style="float:right;"><em>Provided by: <a href="ifpack2">Ifpack2</a> </em></span><br />
...
- <strong>Multilevel Domain Decomposition</strong> <span style="float:right;"><em>Provided by: <a href="shylu">ShyLU</a> (subpackage FROSch)</em></span><br />
...
- <strong>Multigrid Methods</strong> <span style="float:right;"><em>Provided by: <a href="muelu">MueLu</a> </em></span><br />
...
- <strong>Physics-Based Block Preconditioners</strong> <span style="float:right;"><em>Provided by: <a href="teko">Teko</a> </em></span><br />
...
- <strong>Finite Element Local Assembly</strong> <span style="float:right;"><em>Provided by: <a href="intrepid2">Intrepid2</a> </em></span><br />
...
- <strong>Finite Element Assembly for Multiphysics Systems</strong> <span style="float:right;"><em>Provided by: <a href="panzer">Panzer</a> </em></span><br />
...
- <strong>Field Evaluation and Dependency Management</strong> <span style="float:right;"><em>Provided by: <a href="phalanx">Phalanx</a> </em></span><br />
...
- <strong>Meshless Approximation of Linear Operators</strong> <span style="float:right;"><em>Provided by: <a href="compadre">Compadre</a> </em></span><br />
...
- <strong>Nonlinear Solvers</strong> <span style="float:right;"><em>Provided by: <a href="nox_and_loca">NOX</a> </em></span><br />
...
- <strong>Continuation and Stability Analysis</strong> <span style="float:right;"><em>Provided by: <a href="nox_and_loca">NOX</a> (subpackage LOCA)</em></span><br />
...
- <strong>Transient Solvers</strong> <span style="float:right;"><em>Provided by: <a href="tempus">Tempus</a> </em></span><br />
...
- <strong>Forward and Reverse Mode AD</strong> <span style="float:right;"><em>Provided by: <a href="sacado">Sacado</a> </em></span><br />
...
- <strong>Uncertainty Quantification and Stochastic Methods</strong> <span style="float:right;"><em>Provided by: <a href="stokhos">Stokhos</a> </em></span><br />
...
- <strong>Partitioning and Load Balancing</strong> <span style="float:right;"><em>Provided by: <a href="https://sandialabs.github.io/Zoltan/">Zoltan</a> , <a href="zoltan2">Zoltan2</a> </em></span><br />
...
- <strong>Mesh Generation</strong> <span style="float:right;"><em>Provided by: <a href="pamgen">PAMGEN</a> </em></span><br />
...
- <strong>Mesh Manipulation</strong> <span style="float:right;"><em>Provided by: <a href="https://github.com/sandialabs/seacas">SEACAS</a> , <a href="stk">STK</a> , <a href="percept">Percept</a> </em></span><br />
...
- <strong>Mesh I/O</strong> <span style="float:right;"><em>Provided by: <a href="https://github.com/sandialabs/seacas">SEACAS</a> , <a href="stk">STK</a> </em></span><br />
...
- <strong>Cell Topology</strong> <span style="float:right;"><em>Provided by: <a href="shards">Shards</a> </em></span><br />
...
- <strong>Level-Set Methods</strong> <span style="float:right;"><em>Provided by: <a href="krino">Krino</a> </em></span><br />
...
- <strong>Mesh Refinement and Adaptivity</strong> <span style="float:right;"><em>Provided by: <a href="stk">STK</a> </em></span><br />
...
- <strong>Mesh Quality Assessment</strong> <span style="float:right;"><em>Provided by: <a href="https://github.com/sandialabs/seacas">SEACAS</a> , <a href="percept">Percept</a> </em></span><br />
...
- <strong>Mesh-Based Data Transfer</strong> <span style="float:right;"><em>Provided by: <a href="https://github.com/sandialabs/seacas">SEACAS</a> , <a href="stk">STK</a> </em></span><br />
...
- <strong>Unified Solver Interface</strong> <span style="float:right;"><em>Provided by: <a href="stratimikos">Stratimikos</a> </em></span><br />
...
- <strong>Python Wrappers</strong> <span style="float:right;"><em>Provided by: <a href="PyTrilinos2">PyTrilinos2</a> </em></span><br />
...
- <strong>Abstract Numerical Algorithms</strong> <span style="float:right;"><em>Provided by: <a href="thyra">Thyra</a> </em></span><br />
...
- <strong>Reduction/Transformation Operators</strong> <span style="float:right;"><em>Provided by: <a href="rtop">RTOp</a> </em></span><br />
...
- <strong>Simulation and Optimization Interface</strong> <span style="float:right;"><em>Provided by: <a href="piro">Piro</a> </em></span><br />
...
- <strong>Utility and Helper Tools</strong> <span style="float:right;"><em>Provided by: <a href="teuchos">Teuchos</a> </em></span><br />
...
- <strong>Matrix-Free Linear Algebra</strong> <span style="float:right;"><em>Provided by: <a href="galeri">Galeri</a> </em></span><br />
...
- <strong>Tensor Algebra Utilities</strong> <span style="float:right;"><em>Provided by: <a href="minitensor">MiniTensor</a> </em></span><br />
